    ...
    return (
        <div className={styles.bkg}>
            ...
            <div className={styles.filterC}>
                ...
                <Link to='/'> <button className={styles.create}>Inicio</button></Link>
                <Link to='/recipe'> <button className={styles.create}>Crear Receta </button></Link>

                <button onClick={e => handleOnClick(e)} className={styles.refresh}> Actualizar Recetas</button>
            ...
            <form onSubmit={(e) => { handleSubmit(e) }}>
                ...
                <button type='submit' className={styles.btnsearch}>búsqueda</button>
            </form>
